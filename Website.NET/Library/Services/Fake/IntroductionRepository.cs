        ...
        public Introduction Read()
        {
            return new Introduction
            {
                ...
                Description = string.Join(Environment.NewLine,
                    "You can see my work in the tabs above. But first, a quick introduction:",
                    ...
                    "If you'd like to contact me because you have a question or want to discuss an opportunity, please do! You can see a link to my resume on the top right.")
            };
        }
