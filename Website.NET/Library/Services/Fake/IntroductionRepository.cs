        ...
        public Introduction Read()
        {
            return new Introduction
            {
                ...
                Description = string.Join(Environment.NewLine,
                    ...
                    "If you'd like to contact me because you have a question or want to discuss an opportunity, please do! You can find a contact form, along with a link to my resume, on the 'Resume And Contact Information' tab.")
            };
        }
